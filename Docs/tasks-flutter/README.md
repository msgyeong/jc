...
## 현재 진행 상황 (2026-03-08 기준)

| 단계 | 상태 | 비고 |
|------|------|------|
| 01 프로젝트 설정 및 인증 | **거의 완료** | 비밀번호 찾기/재설정 미구현 |
| 02 게시글 기능 | **미착수** | 웹 앱에서 일부 구현됨 |
| 03 공지사항 및 일정 | **대부분 완료** | 일정 수정, 공지 댓글 미구현 |
| 04 회원/프로필 및 홈 | **대부분 완료** | 배너 기능 미구현 |
| 06 공통 기능 | **부분 완료** | 에러 핸들러, 이미지 업로드 완료 |
| 07 테스트 및 마무리 | **미착수** | |
...
- 2026-03-08: Railway API 연동 완료, 플레이스홀더 화면 구현 (홈/일정/회원/프로필/참석조사)
- 2026-03-07: Supabase 관련 코드/문서 완전 제거, Railway API 클라이언트 구현
