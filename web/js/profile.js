                ...
                <div class="info-section">
                    ...
                    <div class="form-group">
                        ...
                        <div id="sns-links-container">
                            ${typeof renderSnsEditList === 'function' ? renderSnsEditList(p.sns_links || p.business_social_links) : (typeof renderSocialLinksForm === 'function' ? renderSocialLinksForm(p.business_social_links || p.sns_links) : '')}
                        </div>
                        <button type="button" class="btn btn-outline btn-sm" onclick="if(typeof addSnsLinkRow==='function')addSnsLinkRow();else if(typeof addSocialLinkField==='function')addSocialLinkField();" style="margin-top:8px">+ SNS 추가</button>
                    </div>
                </div>
...
async function handleProfileEditSubmit(event) {
    ...
    const data = {
        ...
        sns_links: typeof collectSnsLinks === 'function' ? collectSnsLinks() : null,
        business_headline: document.getElementById('edit-one-line-pr')?.value?.trim() || null,
        business_description: document.getElementById('edit-service-description')?.value?.trim() || null,
        business_address: document.getElementById('edit-biz-address')?.value?.trim() || null,
        business_social_links: typeof collectSocialLinks === 'function' ? collectSocialLinks() : (typeof collectSnsLinks === 'function' ? collectSnsLinks() : null)
    };
