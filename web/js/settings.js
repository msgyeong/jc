...
function showPrivacyPage() {
    ...
    container.innerHTML = ''
        ...
        + '<p><strong>2. 개인정보의 이용 목적</strong><br>① 회원 식별 및 가입 승인<br>② 공지사항, 일정 등 서비스 제공<br>③ 푸시 알림 발송<br>④ 회원 간 연락처 공유 (앱 내 한정, 전화번호 공개 범위 설정에 따름)<br>⑤ 주소 좌표 변환을 위한 외부 API 위탁 처리</p>'
        + '<p><strong>3. 개인정보의 보유 및 이용 기간</strong><br>① 회원 탈퇴 시부터 90일간 보관 후 완전 파기합니다.<br>② 관련 법령에 따라 보존이 필요한 경우 해당 기간 동안 보관합니다.</p>'
        ...
        + '<p><strong>6. 개인정보의 파기</strong><br>보유 기간이 경과하거나 처리 목적이 달성된 경우 지체 없이 파기합니다.</p>'
        + '<p><strong>7. 이용자의 권리</strong><br>이용자는 언제든지 본인의 개인정보를 열람, 정정, 삭제 요구할 수 있으며, 프로필 수정 또는 회원 탈퇴를 통해 처리할 수 있습니다.</p>'
        + '<p><strong>8. 개인정보 보호 책임자</strong><br>영등포청년회의소 사무국<br>문의: 앱 내 관리자 연락</p>'
        + '<p style="color:var(--text-secondary);font-size:13px;margin-top:16px">시행일: 2026년 1월 1일</p>'
        + '</div>'
        + '</div>';
}
